...
<center> 
![Random Month for Each Cell with 'NoFire' Event](./img/rand.rast0.png){width=49%} 
</center>
...
<center> 
![Pattern for cells with 'no fire' and no missing data](./img/landSurfaceTemp0.ind.rand.png){width=49%} 
</center>
...
<center> 
![Missing data in 'Land Surface Temprature'](./img/landSurfaceTemp0.rand.NA.mask.png){width=49%} 
</center>
...
<center> 
![landSurfaceTemp0.NA.dt](./img/landSurfaceTemp0.NA.dt.png){width=49%} 
</center>
...
<center> 
![landSurfaceTemp0.NA.sample.dt](./img/landSurfaceTemp0.NA.sample.dt.png){width=49%} 
</center>
...
<center> 
![Pattern of Cells with 'No Fire' and Missing Data](./img/landSurfaceTemp0.rand.NA.mask_p.png){width=49%} 
</center>
...
<center> 
![Pattern of Cells with 'No Fire'](./img/rand.p0.all.rast.png){width=49%}
</center>
...
<center> 
![intersc.burntA.LandSurfTemp.dt](./img/intersc.burntA.LandSurfTemp.dt_1.png){width=49%}
![intersc.burntA.LandSurfTemp.dt](./img/intersc.burntA.LandSurfTemp.dt_2.png){width=49%}
</center>
...
<center> 
![intersc.burntA.LandSurfTemp.sample.dt](./img/intersc.burntA.LandSurfTemp.sample.dt.png){width=49%}
</center>
...
<center> 
![Pattern Cells that can be 'Water/No Fire' Regions](./img/rand.p2.all.rast.png){width=49%}
</center>
...
<center> 
![Pattern of Cells with 'No Fire' Events](./img/rand.p0.p2.all.rast.png){width=49%}
</center>
...
<center> 
![Amazon.data0.dt_1](./img/Amazon.data0.dt_1.png){width=49%}
![Amazon.data0.dt_2](./img/Amazon.data0.dt_2.png){width=49%}
</center>
