...
for (ras_id in amaz.var.list){ # ras_id <- amaz.var.list[1]
  cat("\n", ras_id)
  ras <- rast(ras_id)
...
# save(freq.dt, file = paste0(path0, "/Amazon_new_data/1. Burnt Area/freq_fires.Rdata"))
load(paste0(path0, "/Amazon_new_data/1. Burnt Area/freq_fires.Rdata")) # freq.dt
...
```{r}
dcast(ras.freq,layer ~ value,value.var = c("count"))
