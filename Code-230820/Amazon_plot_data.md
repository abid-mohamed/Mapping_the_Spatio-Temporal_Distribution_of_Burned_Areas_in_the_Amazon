...
```
## SpatRaster resampled to ncells = 500821
```

![](Amazon_plot_data_files/figure-html/1.1.Burnt Area-1.png)<!-- -->


```r
Q1 <- rast("/Users/ABIDM/Documents/Project/Code_official_data/Amazon_new_data/1. Burnt Area/Q1_238.tif") 
...
![](Amazon_plot_data_files/figure-html/1.2.Q1-1.png)<!-- -->
...
![](Amazon_plot_data_files/figure-html/2.1.Land Cover-1.png)<!-- -->
...
![](Amazon_plot_data_files/figure-html/3.1.Precipitation-1.png)<!-- -->
...
![](Amazon_plot_data_files/figure-html/4.1.Soil Moisture-1.png)<!-- -->
...
![](Amazon_plot_data_files/figure-html/5.1.Elevation-1.png)<!-- -->
...
![](Amazon_plot_data_files/figure-html/6.1.LandSurfaceTemp-1.png)<!-- -->
...
![](Amazon_plot_data_files/figure-html/7.1.Specific Humidity-1.png)<!-- -->
...
![](Amazon_plot_data_files/figure-html/8.1.Evapotranspiration-1.png)<!-- -->
...
![](Amazon_plot_data_files/figure-html/9.1.Wind Speed-1.png)<!-- -->
...
![](Amazon_plot_data_files/figure-html/10.1.Air Temperature-1.png)<!-- -->
...
![](Amazon_plot_data_files/figure-html/11.Zones-1.png)<!-- -->
